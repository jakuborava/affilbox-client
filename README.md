...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jakuborava/affilbox-client/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/jakuborava/affilbox-client/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/affilbox-client.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/affilbox-client)
...
```bash
php artisan vendor:publish --tag="affilbox-client-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="affilbox-client-views"
```

## Usage

```php
$affilboxClient = new JakubOrava\AffilboxClient();
echo $affilboxClient->echoPhrase('Hello, JakubOrava!');
```
